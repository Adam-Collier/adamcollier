  ...
  return (
    <main className="block max-w-2xl mx-auto px-4 py-16 md:py-24 flex flex-col gap-10">
      <section className="flex flex-col gap-4">
        <h1 className="text-3xl">Hey, I'm Adam Collier</h1>
      ...
      <section className="flex flex-col gap-4">
        <p>
          ...
          last few I've finished. All pulled from my Oku.club feed.
        </p>
      ...
      <section className="flex flex-col gap-4">
        <p>
          Struggling for a film to watch? Here's the latest five from my
          Letterboxd
        </p>
        <div className="flex gap-2">
          {data.latestFilms.map(
